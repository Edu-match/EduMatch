        ...
        <CardContent className="p-6 md:p-8">
          <div className="prose prose-sm max-w-none text-foreground space-y-6">
            <section>
              ...
              <p>
                AIナビゲーター（チャット）は、会員の方が公平にご利用いただけるよう、<strong>直近24時間あたり10回まで</strong>のご利用としています。
            ...
            <section>
              ...
              <p>
                例えば、昨日の同じ時刻に1回利用している場合、今日のその時刻を過ぎると、その1回分が枠から外れ、あと1回利用できる状態になります。10回すべて使い切った場合は、<strong>いちばん古い利用から24時間経過したタイミングで、その1回分が回復</strong>します。
              </p>
              <p>
                チャット画面の上部には「あと○時間○分で0にリセット」または「○/10 回」と表示されています。ここで、次に1回分がいつ回復するか（または、いつまでに使うと10回の枠がリセットされるか）を確認できます。「詳細を見る」からこのページをご覧いただけます。
              </p>
            </section>
