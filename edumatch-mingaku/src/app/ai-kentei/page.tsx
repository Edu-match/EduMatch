      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="grid md:grid-cols-3 gap-6 mb-16">
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold">約15分</p>
              <CardDescription className="mt-1">全25問の選択式問題</CardDescription>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold">80%以上</p>
              <CardDescription className="mt-1">25問中20問以上正解</CardDescription>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold">即時発行</p>
              <CardDescription className="mt-1">合格後すぐにダウンロード可能</CardDescription>
            </CardContent>
          </Card>
        </section>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-6 text-center">出題範囲</h2>
        ...
        <section className="text-center bg-card border rounded-2xl p-8 md:p-12">
          ...
          <h2 className="text-2xl font-bold mb-3">今すぐ検定に挑戦</h2>
          <p className="text-muted-foreground mb-6 max-w-md mx-auto">
            50問の問題バンクからランダムに25問が出題されます。何度でも受験可能です。
          </p>
          <p className="text-sm text-muted-foreground mb-6">
            ※ ログイン後に受験すると、認定証がマイページから確認できます
          </p>
          <Button asChild size="lg" className="text-base px-8">
            <Link href="/ai-kentei/exam/start">検定を開始する</Link>
          </Button>
        </section>
