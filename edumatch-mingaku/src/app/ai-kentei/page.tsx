...
export default function AiKenteiPage() {
  ...
  const goToExamStart = () => {
    if (!isLoggedIn) {
      toast.info('生成AI活用ガイドライン検定を受けるには、無料会員登録（ログイン）が必要です。')
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="text-center mb-12">
            ...
            <h1 className="display-title text-4xl md:text-5xl text-foreground mb-4 text-balance">
              生成AI活用ガイドライン検定
            </h1>
          ...
          <section className="grid md:grid-cols-3 gap-6 mb-12">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardTitle className="text-sm font-medium text-muted-foreground">試験時間</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-3xl font-bold tracking-tight text-foreground">約15分</p>
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardTitle className="text-sm font-medium text-muted-foreground">合格基準</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-3xl font-bold tracking-tight text-foreground">80%以上</p>
                <CardDescription className="mt-1">
                  25問中20問以上正解
                </CardDescription>
              </CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardTitle className="text-sm font-medium text-muted-foreground">認定証</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-3xl font-bold tracking-tight text-foreground">即時発行</p>
                <CardDescription className="mt-1">
                  合格後すぐにダウンロード可能
                </CardDescription>
              </CardContent>
          ...
          <section className="mb-12">
            <h2 className="section-title text-foreground mb-6 text-center">出題範囲</h2>
          ...
          {/* CTA */}
          <section className="text-center bg-card border rounded-2xl p-8 md:p-12">
