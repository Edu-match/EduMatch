    ...
    <div className="container py-8 md:py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <Card className={`border-2 mb-8 ${session.passed ? 'border-green-500/50 bg-green-50/50 dark:bg-green-950/20' : 'border-red-500/50 bg-red-50/50 dark:bg-red-950/20'}`}>
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-3xl md:text-4xl font-bold">{session.score}</p>
                <p className="text-sm text-muted-foreground">正解数</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold">{questions.length}</p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold">解答詳細</h2>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            {question.tag && (
                              <Badge variant="outline" className="text-xs">{question.tag}</Badge>
                            )}
                          </div>
