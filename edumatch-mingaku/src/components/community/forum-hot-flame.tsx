...
/** イラスト風の炎エフェクト（ホットな話題用）。複数同時表示に対応するため useId で gradient ID を一意化。 */
export function ForumHotFlame({
  ...
  const outerGradId = `fo-${uid}`;
  const innerGradId = `fi-${uid}`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <defs>
          <linearGradient id={outerGradId} x1="16" y1="4" x2="16" y2="28" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FF9A3C" />
            <stop offset="0.55" stopColor="#FF5C1A" />
            <stop offset="1" stopColor="#E63B00" />
          </linearGradient>
          <linearGradient id={innerGradId} x1="16" y1="9" x2="16" y2="25" gradientUnits="userSpaceOnUse">
