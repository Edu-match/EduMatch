...
const VENUES = [
  { key: "国際会議室", label: "国際会議室", bg: "bg-emerald-50", border: "border-emerald-300", ring: "ring-emerald-500", selectedBg: "bg-emerald-100", text: "text-emerald-800" },
  { key: "ステージ①", label: "ステージ①円卓", bg: "bg-blue-50", border: "border-blue-300", ring: "ring-blue-500", selectedBg: "bg-blue-100", text: "text-blue-800" },
  { key: "ステージ②", label: "ステージ②", bg: "bg-amber-50", border: "border-amber-300", ring: "ring-amber-500", selectedBg: "bg-amber-100", text: "text-amber-800" },
] as const;
